...
<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <a href="" class="sign-in-account__btn d-none d-lg-flex">ورود به <?php echo e($ww); ?></a>
        <a class="d-block d-lg-none user-profile__btn" href=""></a>


    </div>
</header><?php /**PATH C:\wamp64\www\mvc_project\resources\views/app/layouts/header.blade.php ENDPATH**/ ?>